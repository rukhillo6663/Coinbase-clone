    ...
    <div className="rounded-div mt-8 w-ful ">
      <div className="my-5 grid gap-2 md:grid-cols-4 sm:grid-cols-3">
        <div>
          ...
          <p className="max-w-[160px] mt-2 text-sm">
            Coinbase is crypto site project made by{" "}
            <a href="https://github.com/rukhillo6663">Joker6663</a>.<br />{" "}
            Website is powered by{" "}
            <a href="https://www.coingecko.com">Coingecko</a> API.
          </p>
        </div>
        <div>
        ...
        <div className="flex flex-col">
          ...
          <div>
            <input
              className="py-1 outline-none text-black text-sm rounded-lg indent-3 my-2 bg-slate-200"
              type="email"
      ...
      <div className="flex justify-center mb-2 text-xs">
        <small>
          Made by <a href="https://github.com/rukhillo6663">@rukhillo6663</a>.
